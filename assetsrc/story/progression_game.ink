...
%drawGraphic: assets/graphics/screaming_scene.png, 43, 215
...
Ok what now?
* [Option 1] I screamed real loud. -> sub
* [Option 2] I shouted very volume. -> sub
* {check_inventory(Rope)}[Option 3] I yelled with amplitude. -> sub
